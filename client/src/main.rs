...
use crate::server::{MainServer, MyTimeoutHandler};
...
async fn main() {
    ...
    let mut server = Arc::new(MainServer::new("127.0.0.1".parse().unwrap(), 8081, 8082, timeout_handler, receive_handler).await);
